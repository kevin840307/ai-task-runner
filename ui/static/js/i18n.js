(() => {
  ...
  const messages = {
    "zh-TW": {
      ...
      "studio.hidden_badge": "Hidden from Chat", "studio.hidden_badge_tip": "此 Workflow 不會出現在聊天視窗的 Workflow 選單；Workflow Studio、CLI 與 Runner 不受影響。",
    ...
    en: {
      ...
      "studio.hidden_badge": "Hidden from Chat", "studio.hidden_badge_tip": "This Workflow is hidden from the Chat picker. Workflow Studio, CLI, and Runner behavior are unchanged.",
