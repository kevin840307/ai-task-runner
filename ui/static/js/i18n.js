(() => {
  ...
  const messages = {
    "zh-TW": {
      ...
      "composer.python_validation": "Python 驗證", "composer.python_validation_short": "Python", "composer.ai_prompt": "AI Prompt", "composer.select_workflow": "選擇 Workflow",
      "options.title": "執行選項", "options.button": "選項",
      "actions.run": "執行", "actions.stop": "停止", "actions.continue": "繼續", "actions.reset": "重設",
      "project.actions": "專案操作", "project.rename": "重新命名專案", "project.rename_title": "重新命名專案", "project.rename_label": "顯示名稱", "project.rename_confirm": "重新命名", "project.renamed": "專案已重新命名", "project.remove": "移除專案", "project.missing": "遺失",
    ...
    en: {
      ...
      "composer.python_validation": "Python validation", "composer.python_validation_short": "Python", "composer.ai_prompt": "AI Prompt", "composer.select_workflow": "Select workflow",
      ...
      "project.actions": "Project actions", "project.rename": "Rename project", "project.rename_title": "Rename Project", "project.rename_label": "Display name", "project.rename_confirm": "Rename", "project.renamed": "Project renamed", "project.remove": "Remove project", "project.missing": "Missing",
