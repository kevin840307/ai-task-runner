...
- Use the minimum code necessary and keep it easy to read. Folder/file/function/class names must clearly match their responsibility.
- Preserve unrelated behavior and existing public interfaces unless the task requires a change. Remove obsolete/dead code rather than keeping parallel old/new implementations.
- Keep human-facing maintained documentation in aligned English `.md` and Traditional Chinese `.zh-TW.md` versions.
