"""Backend contracts and process execution for model CLIs."""
...
from ..runtime.process import ProcessResult, run_process
from .errors import BackendError

ModelMode = Literal["planning", "review", "no_tool", "runtime"]
