...
- Prefer the smallest coherent maintainable change. Preserve unrelated behavior. Do not perform unrelated cleanup, speculative refactoring, or adjacent fixes.
