...
class RunState:
    ...
    def load(cls, data: dict[str, Any]) -> RunState:
        ...
        values = dict(data)
        if "model_session_id" not in values and "agent_session_id" in values:
            values["model_session_id"] = values.pop("agent_session_id")
...
__all__ = ["RunStage", "RunState", "StateStore", "Task", "normalize_state", "set_stage"]
